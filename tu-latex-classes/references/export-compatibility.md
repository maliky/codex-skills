...
- compare output PDF and log for regressions in spacing, title blocks, and metadata
- keep environment variables (`TEXMFVAR`, output directories) explicit in notes
